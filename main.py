...
bot = Bot(token='5357337704:AAHV-MOPCy2SHgJJiWuatDV0Oa8YEyar5aM')
dp = Dispatcher(bot)
...
@dp.message_handler(text=['Изменить группу', 'Поменять группу', 'Выбрать группу'])
async def edit_group(message: types.Message):
    await bot.send_message(chat_id=message.chat.id, text="Напишите, на какую группу вы хотите изменить")
...
@dp.message_handler(text=['Расписание', 'Рассписание на завтра'])
